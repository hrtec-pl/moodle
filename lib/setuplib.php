...
function setup_get_remote_url() {
    ...
    //ominięcie sprawdzenia SERVER_SOFTWARE, kiedy jest ukryte w Apache HRtec
     $oldServerSoftware = $_SERVER['SERVER_SOFTWARE'];
...
/* NOTE: following servers are not fully tested! */
    ...
    //by HRtec - przywrócenie zmiennej zmienianej na początku funkcji
    if (isset($oldServerSoftware)) {
        $_SERVER['SERVER_SOFTWARE'] = $oldServerSoftware;
    }
